...
if _NV_ONE_LOGGER_AVAILABLE:
    ...
    class OneLoggerNeMoCallback(BaseCallback):
        """No-op fallback when optional `nv_one_logger` is not installed."""

        def __init__(self) -> None:
            self._initialized = True
            logging.warning(
                "nv_one_logger is not installed; OneLoggerNeMoCallback is disabled (no-op). "
