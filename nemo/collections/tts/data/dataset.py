...
class TTSDataset(Dataset):
    def __init__(
        ...
        **kwargs,
        ...
        # Rebuild self.lengths to match filtered self.data so that
        # DistributedBucketSampler generates valid indices after pruning.
        self.lengths = [
            os.path.getsize(item["audio_filepath"]) // (n_fft // 2) for item in self.data
        ]
