...
try:
    ...
    def read_manifest(manifest_path: str):
        """Minimal JSONL manifest reader fallback.

        This keeps TTS unit tests runnable in minimal environments where the ASR
        collection (and its optional deps like lhotse) is not installed.
        """
